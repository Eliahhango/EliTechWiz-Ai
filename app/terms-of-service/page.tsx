...
export const metadata: Metadata = {
  title: "Terms of Service | EliTechWiz-Ai",
  description: "Terms of Service and conditions for EliTechWiz-Ai services.",
  openGraph: {
    title: "Terms of Service | EliTechWiz-Ai",
    description: "Terms of Service and conditions for EliTechWiz-Ai services.",
    type: "website",
    ...
    <div className="px-4 py-8 pb-16 md:px-0">
      <div className="container mx-auto max-w-2xl space-y-6 rounded-md border bg-card px-4 py-8 shadow-lg sm:px-8">
        <h1 className="mb-5 text-center text-3xl font-semibold text-card-foreground">
          EliTechWiz-Ai Terms of Service
        </h1>
        ...
        <div className="mt-4 text-lg leading-relaxed text-card-foreground">
          <ol className="list-inside list-decimal">
            <li className="mb-3">
              ...
              software (&quot;Products&quot;) provided by EliTechWiz-Ai LLC
              (&quot;the Company&quot;) agree to use the Products only for
              lawful purposes and in accordance with all applicable laws,
              regulations, and guidelines.
            </li>
            <li className="mb-3">
              <strong>Limitation of Liability:</strong> Neither EliTechWiz-Ai LLC,
            ...
            <li className="mb-3">
              ...
              harmless EliTechWiz-Ai LLC, its parent companies, and their respective
            ...
            <li className="mb-3">
              <strong>Changes to Terms of Service:</strong> EliTechWiz-Ai LLC
          ...
          <p className="mt-4">
            By using the Products provided by EliTechWiz-Ai LLC, you indicate your
